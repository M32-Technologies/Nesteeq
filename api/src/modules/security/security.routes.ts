...
const verifyPassRateLimitConfig = {
  windowMs: 5 * 60 * 1000,
...
const getVerifyPassRateLimitKey = (req: Request) => {
...
const clearVerifyPassFailures = (key: string) => {
