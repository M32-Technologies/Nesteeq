...
const allowedStatusTransitions: Record<ComplaintStatus, readonly ComplaintStatus[]> = {
  PENDING: ["UNDER_REVIEW", "ASSIGNED", "IN_PROGRESS", "CANCELLED"],
  UNDER_REVIEW: ["ASSIGNED", "IN_PROGRESS", "CANCELLED"],
  ASSIGNED: ["IN_PROGRESS", "CANCELLED"],
  IN_PROGRESS: ["WORK_COMPLETED", "AWAITING_APPROVAL", "CANCELLED"],
  WORK_COMPLETED: ["AWAITING_APPROVAL", "APPROVED", "CLOSED", "REJECTED", "CANCELLED"],
  AWAITING_APPROVAL: ["APPROVED", "CLOSED", "REJECTED", "CANCELLED"],
  APPROVED: ["CLOSED"],
