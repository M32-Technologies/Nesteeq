...
import { ComplaintMaintenanceSection } from "./complaint-maintenance-section"
      ...
      {isLoading ? (
        ...
        <div>
            ...
            <div className="mt-4">
              <InfoGrid
                items={[
                  ...
                  {
                    label: "Resident",
                    value: formatId(complaint.resident),
                  },
                  {
                    label: "Apartment",
                    value: formatId(complaint.apartment),
                  },
                  {
                    label: "Unit",
                    value: formatId(complaint.flat),
                  },
                  {
                    label: "Category",
                  ...
                  },
                  {
                    ...
                    value: formatId(complaint.assignedStaff),
                  },
                  {
                    label: "Estimated cost",
                    value: formatCurrency(complaint.estimatedCost),
                  },
                  {
                    label: "Final cost",
                    value: formatCurrency(complaint.finalCost),
                  },
                  {
                    label: "Created",
          ...
          <section className="py-5">
            ...
            <div className="mt-4">
              <ActivityTimeline notes={complaint.remarks} />
            </div>
          </section>
        </div>
      ) : null}
