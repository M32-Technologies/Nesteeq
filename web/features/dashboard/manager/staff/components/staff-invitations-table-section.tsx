...
import { formatDate, formatLabel, RoleBadge } from "./staff-table-section"
...
export default function StaffInvitationsTableSection() {
  ...
  const {
    ...
    isError,
    error,
  } = useStaffInvitationsQuery(params)
  const resendInvitation = useResendStaffInvitationMutation()
  const revokeInvitation = useRevokeStaffInvitationMutation()
  ...
  const handleRevoke = async (invitation: StaffInvitation) => {
    setActionId(invitation.id)
    ...
    <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
      ...
      <div className="overflow-x-auto">
              ...
              invitations.map((invitation) => (
                ...
                >
                  ...
                  <td className="px-4 py-4 text-sm text-slate-600">
                    {invitation.role === "maintenance_technician"
                      ? invitation.maintenanceType
                      : "-"}
                  </td>
        ...
        {!isLoading && !isError && invitations.length === 0 && (
          <StateMessage message="No staff invitations found" />
        )}
      </div>
