...
export const getParkingSlots = async (
  ...
  try {
    ...
    if (params.vehicleType && params.vehicleType !== ("ALL" as any)) {
      cleanParams.vehicleType = params.vehicleType
    }
    if (params.usageType && params.usageType !== ("ALL" as any)) {
      cleanParams.usageType = params.usageType
    }
