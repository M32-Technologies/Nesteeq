    ...
    <div className="w-full">
      ...
      <div className="mb-6 flex justify-end">
        <button
          type="button"
          onClick={handleSave}
          className="inline-flex items-center gap-2 rounded-xl bg-[#07584F] px-4 py-2.5 text-xs font-semibold text-white shadow-xs transition-colors hover:bg-[#064C44] cursor-pointer"
        >
